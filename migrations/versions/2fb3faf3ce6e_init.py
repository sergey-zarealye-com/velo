...
Revision ID: 2fb3faf3ce6e
Revises: 
Create Date: 2021-08-09 14:50:18.188799
...
def upgrade():
    ...
    op.create_table('celerytasks',
    sa.Column('video_uuid', sa.String(), nullable=False),
    sa.Column('cv_task_id', sa.String(), nullable=False),
    sa.Column('nlp_task_id', sa.String(), nullable=False),
    sa.Column('todo_id', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('cv_task_id', 'nlp_task_id')
    )
    ...
    sa.Column('new_category', sa.Integer(), nullable=False),
    ...
    sa.Column('task', sa.SmallInteger(), nullable=False),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('kf_uid', sa.String(), nullable=True),
    sa.Column('local_chkpoint', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['version_id'], ['versions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('cv_status', sa.String(), nullable=True),
    sa.Column('nlp_status', sa.String(), nullable=True),
    sa.Column('video_uuid', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['version_id'], ['versions.id'], ),
    sa.PrimaryKeyConstraint('id'),
